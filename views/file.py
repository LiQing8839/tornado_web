...
class SyncHandler(BaseHandler):
    ...
    def get(self):
        ...
        self.render("sync.html", web_title="运维管理平台", user=self.current_user, page="同步文件", action="", tip=self.application.data.GetDAll(sql1), wip=self.application.data.GetDAll(sql2), data=d)
